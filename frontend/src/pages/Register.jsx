...
const Register = () => {
  ...
  const inputStyle = {
    ...
    border: '1px solid #3a3a3a', borderRadius: '6px', padding: '13px 16px',
  ...
  return (
    <div style={{
      minHeight: '100vh', backgroundColor: '#121212', display: 'flex',
      ...
      <div style={{ width: '100%', maxWidth: '420px', padding: '0 24px' }}>
        <div style={{
          ...
          borderRadius: '12px', padding: '48px 40px 40px',
        }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '36px' }}>
            ...
            <h1 style={{ fontSize: '22px', fontWeight: '500', color: '#e8eaed', margin: '0 0 6px' }}>Create account</h1>
            <p style={{ fontSize: '13px', color: '#9aa0a6', margin: 0 }}>Join NexShip today</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading}
              style={{
                width: '100%', backgroundColor: '#1a73e8', color: 'white', border: 'none',
                borderRadius: '6px', padding: '13px', fontSize: '15px', fontWeight: '500',
                cursor: loading ? 'not-allowed' : 'pointer', fontFamily: 'inherit',
                opacity: loading ? 0.7 : 1, transition: 'background-color 0.15s', letterSpacing: '0.25px',
              }}
          ...
          <p style={{ textAlign: 'center', fontSize: '13px', color: '#9aa0a6', margin: 0 }}>
            ...
            <Link to="/login" style={{ color: '#8ab4f8', textDecoration: 'none', fontWeight: '500' }}>Sign in</Link>
          </p>
        </div>
